...
def loadCam(args, id, cam_info, resolution_scale):
    ...
    #intrinsics = np.array([[focal_length_x//scale, 0, resolution[0]/2],[0, focal_length_y//scale, resolution[1]/2], [0, 0, 1]]).astype(np.float32)
    intrinsics = np.array(
        [[focal_length_x // scale, 0, intrinsics[0,2]], [0, focal_length_y // scale, intrinsics[1,2]],
